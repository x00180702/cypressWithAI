...
Feature: Out of Range age value
  ...
  Scenario: Test Case 11
    ...
    And user enters "bloodpressureCT11" in the Systolic field on the 'Blood Pressure' application
    ...
    Then user clicks on the submit button on the 'Blood Pressure' application
    Then "Invalid Age Range. Calculations are for ages over 15 & under 100" error message is displayed on the 'Blood Pressure Containerised' application
