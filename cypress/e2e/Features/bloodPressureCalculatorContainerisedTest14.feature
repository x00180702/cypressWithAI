...
Feature: Check All Values
  ...
  Scenario: Test Case 14
    ...
    And user enters "bloodpressureCT14" in the Systolic field on the 'Blood Pressure' application
    ...
    Then "Pulse Pressure: 90" results are displayed under the 'Pulse Pressure' field on the 'Blood Pressure' application
