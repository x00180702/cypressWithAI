...
Feature: Invalid (double) values
  ...
  Scenario: Test Case 15
    ...
    Then user clicks on the submit button on the 'Blood Pressure' application
    Then "Please enter a valid value. The two nearest valid values are 172 and 173." error message is displayed under the "Diastolic" field on the 'Blood Pressure Containerised' application
    And user enters "66" in the Diastolic field on the 'Blood Pressure' application
    Then user clicks on the submit button on the 'Blood Pressure' application
    Then "Please enter a valid value. The two nearest valid values are 172 and 173." error message is displayed under the "Age" field on the 'Blood Pressure Containerised' application
    Then user clicks on the submit button on the 'Blood Pressure' application
